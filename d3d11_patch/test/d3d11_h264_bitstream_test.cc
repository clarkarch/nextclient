// d3d11_h264_bitstream_test.cc
// Standalone unit test for D3d11AvccToAnnexB (the d3d11_patch copy of the
// vaapi_patch converter). Compile with plain g++ (no deps):
//   g++ -std=c++17 -I d3d11_patch d3d11_patch/test/d3d11_h264_bitstream_test.cc -o /tmp/d3d11_avcc_test && /tmp/d3d11_avcc_test
#include <cassert>
#include <cstdint>
#include <cstdio>
#include <cstdlib>
...
using libwebrtc::D3d11AvccToAnnexB;
